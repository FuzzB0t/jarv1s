...
<html><head><title>Jarv1s - WhatsApp Auth</title>
...
<html><head><title>Jarv1s - Connected!</title>
<style>
...
<script>localStorage.removeItem('jarv1s_qr_start');</script>
</body></html>`;
